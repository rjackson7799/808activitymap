...
insert into public.app_config (key, value, description) values
  ...
  ('badge_freshness_rules',
   '{"badge_fields":["name","address","geo","phone","hours","photo","primary_category"],"suspend_on_stale":true}',
...
values
  ...
  ('locations', 'b0000000-0000-4000-8000-000000000001', 'geo',
   'vendor', 'in_person_visit', '99000000-0000-4000-8000-000000000002', 'approved', '2027-07-10T00:00:00Z', true),
  ('locations', 'b0000000-0000-4000-8000-000000000001', 'phone',
   'vendor', 'in_person_visit', '99000000-0000-4000-8000-000000000002', 'approved', '2027-07-10T00:00:00Z', true),
  ('listings', 'c0000000-0000-4000-8000-000000000001', 'primary_category',
   'vendor', 'in_person_visit', '99000000-0000-4000-8000-000000000002', 'approved', '2027-07-10T00:00:00Z', true),
  ('media', 'f0000000-0000-4000-8000-000000000001', 'rights',
   'vendor', 'permission_form', '99000000-0000-4000-8000-000000000002', 'approved', '2027-07-10T00:00:00Z', true),
  ...
  ('locations', 'b0000000-0000-4000-8000-000000000002', 'hours',
   'vendor', 'hours_confirmation', '99000000-0000-4000-8000-000000000002', 'approved', '2026-10-10T00:00:00Z', true),
  ('locations', 'b0000000-0000-4000-8000-000000000002', 'geo',
   'vendor', 'in_person_visit', '99000000-0000-4000-8000-000000000002', 'approved', '2027-07-10T00:00:00Z', true),
  ('locations', 'b0000000-0000-4000-8000-000000000002', 'phone',
   'vendor', 'in_person_visit', '99000000-0000-4000-8000-000000000002', 'approved', '2027-07-10T00:00:00Z', true),
  ('listings', 'c0000000-0000-4000-8000-000000000002', 'primary_category',
   'vendor', 'in_person_visit', '99000000-0000-4000-8000-000000000002', 'approved', '2027-07-10T00:00:00Z', true),
  ('media', 'f0000000-0000-4000-8000-000000000006', 'rights',
   'vendor', 'permission_form', '99000000-0000-4000-8000-000000000002', 'approved', '2027-07-10T00:00:00Z', true)
